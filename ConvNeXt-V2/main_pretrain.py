...
import sys
sys.path.append("..")
from gwfss_dataset import GWFSSPretrainDataset
...
def main(args):
    if args.distributed:
        ...
        args.local_rank = os.environ.get("LOCAL_RANK")
    ...
    dataset_train = GWFSSPretrainDataset(data_path=args.data_path, transform=transform_train)
